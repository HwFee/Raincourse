...
> ⚠️ **免责声明**：本项目仅用于学习交流和技术研究，不保证在任何环境下可用。

## ⚠️ 特别声明（与上游项目保持一致）

- 本仓库涉及的脚本与功能仅用于测试、学习与研究，禁止用于商业用途。
- 本项目不保证合法性、准确性、完整性与有效性，请使用者自行判断并承担风险。
- 请严格遵守学校、平台及当地法律法规；因不当使用造成的任何后果由使用者自行承担。
- 本项目遵循 MIT License；若本声明与 MIT 条款存在冲突，以本特别声明的风险提示为补充说明。
- 任何查看、下载、复制、修改或运行本项目代码的行为，均视为已阅读并同意本声明。
- 项目维护者保留随时更新或补充本声明的权利。
